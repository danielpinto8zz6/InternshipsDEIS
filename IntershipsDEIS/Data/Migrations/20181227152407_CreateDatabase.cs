    ...
    public partial class CreateDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IntershipId = table.Column<string>(nullable: false),
                    Title = table.Column<string>(nullable: false),
                    Description = table.Column<string>(nullable: false),
                    Date = table.Column<DateTime>(nullable: false),
                    State = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Intership_Professor_AdvisorId",
                        column: x => x.AdvisorId,
                        principalTable: "Professor",
                        principalColumn: "ProfessorId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Intership_Company_CompanyId",
                        column: x => x.CompanyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Intership_CompanyId",
                table: "Intership",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_IntershipCandidature_CandidateId",
                table: "IntershipCandidature",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_IntershipCandidature_IntershipId",
                table: "IntershipCandidature",
                column: "IntershipId");
